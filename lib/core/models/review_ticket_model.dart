...
//
//     final reviewTicketModel = reviewTicketModelFromJson(jsonString);

import 'dart:convert';

ReviewTicketModel reviewTicketModelFromJson(String str) =>
    ReviewTicketModel.fromJson(json.decode(str));

String reviewTicketModelToJson(ReviewTicketModel data) =>
    json.encode(data.toJson());

class ReviewTicketModel {
  ...
  factory ReviewTicketModel.fromJson(Map<String, dynamic> json) =>
      ReviewTicketModel(
        ticketDetails:
        ...
        machineDetails:
            json["machineDetails"] == null
                ? null
                : MachineDetails.fromJson(json["machineDetails"]),
        customerMachineDetails:
            json["customerMachineDetails"] == null
                ? null
                : CustomerMachineDetails.fromJson(
                  json["customerMachineDetails"],
                ),
        processorDetails:
            json["processorDetails"] == null
                ? null
                : Details.fromJson(json["processorDetails"]),
        organisationDetails:
            json["organisationDetails"] == null
                ? null
                : Details.fromJson(json["organisationDetails"]),
        pricingDetails:
            json["pricingDetails"] == null
                ? null
...
class CustomerMachineDetails {
  ...
  factory CustomerMachineDetails.fromJson(Map<String, dynamic> json) =>
      CustomerMachineDetails(
